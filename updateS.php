...
<h5 class="text-danger p-2"><?php echo $status ?></h5>
                  ...
                  <h6 class="text-danger"><b>You are<span class="text-info" style="font-size:30px"><b> Updating</b></span> the stock records of a particular location. Please verify well before you proceed.</b></h6>
                      ...
                      <button type="submit" name="submit" class="btn btn-outline-success">I'm sure - Update this record</button>
