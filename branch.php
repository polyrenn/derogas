                                ...
                                if($categ == 'Offline-Others'){
                                 ...
                                 <td colspan='2' ><a class='text-white' href='reciept.php?reciept=".$rrec."&branch=".$branchCode."&CompanyName=".$company."''><b> View reciept </b></a></td>
                                  ...
                                  <?php 
                                      ...
                                      $arr = "SELECT crbsold.kg, crbsold.quantity, finalsales.category FROM crbsold, finalsales WHERE crbsold.crbnumber = '$rrec' AND finalsales.reciept = '$rrec' AND crbsold.branch = '$branchCode' AND finalsales.branch = '$branchCode' ";
