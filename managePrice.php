...
<div class="sidebar-heading"><b>Sales</b>
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
      <h1 class="h3 mb-0 text-gray-800">View Price List By Location</h1><br>
    ...
    <div class="col mb-4">
      ...
      <div class="card-body">
<div id='table'>
<table class='table table-striped table-light' border='2' styles="width:100%">
<thead>
...
<?php
    ...
    $createStation->getPriceByLocation($code);
