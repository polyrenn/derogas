            ...
            <div class="row">
              ...
              <div class="card shadow mb-4">
                  <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Update Location Price</h6>
                  </div>
                  <div class="card-body">
                  <form action="updatePricee.php" method="POST" >
                      <h5 class="text-danger"><b>You're about to <span class="text-info" style="font-size:30px"><b>Update</b></span> price for a particular location. Please verify well before you proceed.</b></h5>
                      ...
                      <?php  echo $createStation->getCompanyBranchCode();?>
                          ...
                          <div class="form-group">
                              <input type="number" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Price Per Kg" name="ppKg">
                          </div>
          
                      <button type="submit" name="submit" class="btn btn-outline-primary">Update Price</button>
