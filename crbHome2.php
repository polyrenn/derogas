    ...
    $rogue = mysqli_query($connect, $crbN);
            ...
            if($runit){
                ...
                header("Location: crbHome2.php?msg=true&type=error&details=". urlencode($message) );
            }else{
  ...
  $rogue = mysqli_query($connect, $crbN);
    ...
    $rra = mysqli_query($connect, $runT);
      ...
      if(mysqli_num_rows($canny) > 0){
          ...
          $squee = "SELECT SUM(amount), SUM(amount2) FROM crbs WHERE crbnumber = '$crb' AND branch = '$branchCode' ";
          ...
          if($t1 != $t2){
              ...
              if(mysqli_num_rows($lastock) > 0){
                  ...
                  $sales = "SELECT * FROM crbs WHERE crbnumber = '$crb' AND branch = '$branchCode' ";
                  ...
                  $trr = "SELECT SUM(amount) FROM crbs WHERE crbnumber = '$crb' AND branch = '$branchCode' ";
                  ...
                  if(mysqli_num_rows($runsales) > 0){
                      ...
                      $gf = "SELECT amount2 FROM crbs WHERE crbnumber = '$crb' AND branch = '$branchCode' ORDER BY id DESC LIMIT 1 ";
    ...
    <body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div class="container">
                ...
                <button class="btn btn-outline-success"> <a href="crbHome.php" style="text-decoration: none;">Go Back Online</a> </button>
                </div>
...
<input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="Offline-Domestic" name="category" readonly>
</div>
...
<form action="crb2.php" method="POST" id="crbForm">
...
<h5 class='text-danger' align="center">Offline - Dealer category</h5>
<table class='table table-striped table-dark'>
<thead>
<tr>
<th scope='col'>Cylinder Sizes</th>
...
<div class="row">
<div class=" col-md-2 form-group" style="visibility:hidden">
<input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="Offline-Dealer" name="category" readonly>
</div>
...
<h5 class='text-danger' align="center">Offline - Eatery category</h5>
<table class='table table-striped table-dark'>
<thead>
<tr>
<th scope='col'>Cylinder Sizes</th>
...
<div class="row">
<div class=" col-md-2 form-group" style="visibility:hidden">
<input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="Offline-Eatery" name="category" readonly>
</div>
...
<h5 class='text-danger' align="center">Offline - Others category</h5>
<table class='table table-striped table-dark'>
<thead>
<tr>
<th scope='col'>Cylinder Sizes</th>
...
<div class="row">
<div class=" col-md-2 form-group" style="visibility:hidden">
<input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="Offline-Others" name="category" readonly>
</div>
...
<input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo date("h:i:s a"); ?>" name="time" readonly>
                    ...
                    <div class="card-body">
                        <form action=" " method="POST" id="off">
        ...
        <div id="crbprintt">
                            ...
                            <tbody>
                                ...
                                <?php $createStation->getCRBB(); ?>

                                </tbody>
                                    </table>
                                    <h5 align="center"><b> - Not for sale. For records purposes only -</b></h5>
                               </div>
                               <h5 align="center"> <a href="" onclick='printContent("crbprintt"); document.getElementById("off").submit();'><b>Please Print Crb First</b></a> </h5>
                                    <div class="container">
                                  ...
                                  <div class="container">
                                    ...
                                    <div class="col col-md-6">
    <button class='col-12 btn btn-success' type='submit' name="com">Complete Sales</button>
...
<?php
    ...
    $sql = "SELECT * FROM stepcomplete WHERE branch = '$branchCode' ORDER BY id ASC LIMIT 1";
    ...
    if($su){
        ...
        if($amchange != 0){
           ...
           $rat = "SELECT Cchange FROM customers WHERE Cphone = '$phone'";
...
<form action='filter2.php' method='POST' id='tosales'>
                ...
                <div class="modal-content">
                    ...
                    <div class="row">
                        ...
                        $dt = date('Y-m-d', strtotime('now'));
                            ...
                            $Others = "SELECT DISTINCT(crbnumber) FROM crbs WHERE datee = '$dt' AND branch = '$branchCode' AND category = 'Offline-Others' AND amount != 0 ";
                            ...
                            if($goOther){
                                ...
                                $k = "SELECT SUM(tquant) FROM crbs  WHERE datee = '$dt' AND branch = '$branchCode' AND category = 'Offline-Others' AND amount != 0 ";
                                $kk = mysqli_query($connect, $k);
                                $kr = mysqli_fetch_array($kk);
                                $alkg = $kr['SUM(tquant)'];

                                 $ka = "SELECT SUM(amount) FROM crbs  WHERE datee = '$dt' AND branch = '$branchCode' AND category = 'Offline-Others' AND amount != 0 ";
                        ...
                        $dt = date('Y-m-d', strtotime('now'));
                             ...
                             $Others = "SELECT DISTINCT(crbnumber) FROM crbs WHERE datee = '$dt' AND branch = '$branchCode' AND category = 'Offline-Dealer' AND amount != 0 ";
                            $goOther = mysqli_query($connect, $Others);
                            ...
                            if($goOther){
                                ...
                                $k = "SELECT SUM(tquant) FROM crbs  WHERE datee = '$dt' AND branch = '$branchCode' AND category = 'Offline-Dealer' AND amount != 0 ";
                                $kk = mysqli_query($connect, $k);
                                $kr = mysqli_fetch_array($kk);
                                $alkg = $kr['SUM(tquant)'];

                                 $ka = "SELECT SUM(amount) FROM crbs  WHERE datee = '$dt' AND branch = '$branchCode' AND category = 'Offline-Dealer' AND amount != 0 ";
                                $kka = mysqli_query($connect, $ka);
                                $kra = mysqli_fetch_array($kka);
                                $alkga = $kra['SUM(amount)'];
                        ...
                        $dt = date('Y-m-d', strtotime('now'));
                            ...
                            $Others = "SELECT DISTINCT(crbnumber) FROM crbs WHERE datee = '$dt' AND branch = '$branchCode' AND category = 'Offline-Eatery' AND amount != 0 ";
                            $goOther = mysqli_query($connect, $Others);
                            
                            if($goOther){
                                $oth = mysqli_num_rows($goOther);

                                $k = "SELECT SUM(tquant) FROM crbs  WHERE datee = '$dt' AND branch = '$branchCode' AND category = 'Offline-Eatery' AND amount != 0 ";
                                $kk = mysqli_query($connect, $k);
                                $kr = mysqli_fetch_array($kk);
                                $alkg = $kr['SUM(tquant)'];

                                 $ka = "SELECT SUM(amount) FROM crbs  WHERE datee = '$dt' AND branch = '$branchCode' AND category = 'Offline-Eatery' AND amount != 0 ";
                                $kka = mysqli_query($connect, $ka);
                                $kra = mysqli_fetch_array($kka);
                                $alkga = $kra['SUM(amount)'];
                        ...
                        $dt = date('Y-m-d', strtotime('now'));
                            ...
                            $Others = "SELECT DISTINCT(crbnumber) FROM crbs WHERE datee = '$dt' AND branch = '$branchCode' AND category = 'Offline-Domestic' AND amount != 0 ";
                            $goOther = mysqli_query($connect, $Others);
                            
                            if($goOther){
                                $oth = mysqli_num_rows($goOther);

                                $k = "SELECT SUM(tquant) FROM crbs  WHERE datee = '$dt' AND branch = '$branchCode' AND category = 'Offline-Domestic' AND amount != 0 ";
                                $kk = mysqli_query($connect, $k);
                                $kr = mysqli_fetch_array($kk);
                                $alkg = $kr['SUM(tquant)'];

                                 $ka = "SELECT SUM(amount) FROM crbs  WHERE datee = '$dt' AND branch = '$branchCode' AND category = 'Offline-Domestic' AND amount != 0 ";
                                $kka = mysqli_query($connect, $ka);
                                $kra = mysqli_fetch_array($kka);
                                $alkga = $kra['SUM(amount)'];
