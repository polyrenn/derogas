...
<div class="col-12 col-lg-6 mb-4">
              ...
              <div class="card shadow mb-4">
                  <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Add price to location</h6>
                  </div>
                  <div class="card-body">
                  <form action="addPrice.php" method="POST" >
<h5 class="text-danger"><?php echo $status ?></h5>
                      <h5 class="text-danger"><b>You're about to <span class="text-info" style="font-size:30px"><b>Add</b></span> pricing for a particular locations, please verify well before submitting the price.</b></h5>
                  
                      <div class="form-group">



<h5 class="text-primary">Select company</h5>
                      ...
                      <div class="form-group">
<h5 class="text-primary">Select branch</h5>
...
<td>
<input type="checkbox" name="cylinder[3kg]" value="3"/>
</td>
...
<td>
<input type="checkbox" name="cylinder[5kg]" value="5"/>
</td>
...
<td>
<input type="checkbox" name="cylinder[6kg]" value="6"/>
</td>
...
<td>
<input type="checkbox" name="cylinder[10kg]" value="10"/>
</td>
...
<td>
<input type="checkbox" name="cylinder[15kg]" value="15"/>
</td>
...
<td>
<input type="checkbox" name="cylinder[25kg]" value="25"/>
</td>
...
<td>
<input type="checkbox" name="cylinder[50kg]" value="50"/>
</td>
...
<td>
<input type="checkbox" name="cylinder[Others]" value="Others"/>
</td>
...
<label class="text-primary" id="checkAll">Check All</label>


                          </div>

                          <div class="form-group">
<h5 class="text-primary">Price per Kg</h5>
                              <input type="double" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="ppKg">
                          </div>
          
                      <button type="submit" name="sumitab" class="btn btn-outline-primary">Add new kg / price to location</button>
